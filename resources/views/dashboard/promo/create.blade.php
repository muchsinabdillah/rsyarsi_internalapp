    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Input Promo</h6>
              <p>Silahkan Masukan Data Promo.</p> 
        </div>
        ...
        <form  method="POST" action="/dashboard/promos/prosesCreate" enctype="multipart/form-data"> 
             @csrf
                    ...
                    <div class="form-group">
                        <label for="title" class="form-label">Title</label> 
                            <div class="form-control-wrap">
                                ...
                                name="title" autocomplete="off"   autofocus  value="{{  old('title') }}"> 
                                @error('title') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        <label for="slug" class="form-label">Slug</label> 
                            <div class="form-control-wrap">
                                ...
                                name="slug" autocomplete="off"  readonly autofocus  value="{{  old('slug') }}"> 
                                @error('slug') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        <label for="shortdescription" class="form-label">Short Description</label>
                            <div class="form-control-wrap">
                                ...
                                @enderror
                                    <input id="shortdescription" maxlength="145" class="form-control @error('shortdescription') is-invalid @enderror " type="text" name="shortdescription" value="{{ old('shortdescription') }}">
                    ...
                    <div class="form-group">
                        <label for="startdate" class="form-label">Start Date</label> 
                            <div class="form-control-wrap">
                                ...
                                name="startdate" autocomplete="off"   autofocus  value="{{  old('startdate') }}"> 
                                @error('startdate') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        <label for="enddate" class="form-label">End Date</label> 
                            <div class="form-control-wrap">
                                ...
                                name="enddate" autocomplete="off"   autofocus  value="{{  old('enddate') }}"> 
                                @error('enddate') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
