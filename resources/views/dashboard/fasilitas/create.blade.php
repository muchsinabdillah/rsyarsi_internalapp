    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Input Fasilitas</h6>
        ...
        <form  method="POST" action="/dashboard/fasilitas/prosesCreate" enctype="multipart/form-data"> 
             @csrf
            ...
            <div class="row g-4">
                    ...
                    <div class="form-group">
                        <label for="shortdescription" class="form-label">Deskripsi Singkat</label>
                            <div class="form-control-wrap">
                                ...
                                @enderror
                                    <input id="shortdescription" maxlength="140" class="form-control @error('shortdescription') is-invalid @enderror " type="text" name="shortdescription" value="{{ old('shortdescription') }}">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="longdescription" class="form-label">Deskripsi Lengkap</label>
                            <div class="form-control-wrap">
...
<script > 
    ...
    function backurl() {
        window.location.href = '/dashboard/fasilitas';
    }
