  ...
  <div class="card card-bordered">
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        ...
        <form  method="POST" action="/dashboard/fasilitas/prosesUpdate" enctype="multipart/form-data"> 
             @csrf
                    ...
                    <div class="form-group">
                        <label for="shortdescription" class="form-label">Deskripsi Singkat</label>
                            <div class="form-control-wrap">
                                ...
                                @enderror
                                    <input id="shortdescription" maxlength="140" class="form-control @error('shortdescription') is-invalid @enderror " 
