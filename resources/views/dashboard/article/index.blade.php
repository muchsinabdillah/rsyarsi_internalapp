    ...
    <div class="card-inner">
      <div class="card-title-group align-start mb-2">
        <div class="card-title">
            <h6 class="title">Data Articles</h6>
              <p>Berikut Adalah Data Articles</p>
              <a href="/dashboard/articles/create" class="btn btn-primary"><em class="icon ni ni-setting"></em><span>New</span></a>
        </div>
                    ...
                    <tbody>
                      @foreach ($posts as $post)
                          <tr>
                              ...
                              <td>{{  $post->publish }}</td>
                              <td>
                                  <a href="/dashboard/articles/view/{{ $post->ID }}" class="btn btn-sm btn-info"><i class="icon bi bi-eye"></i></a> 
                              </td> 
                          </tr>
                      @endforeach
                    </tbody>
