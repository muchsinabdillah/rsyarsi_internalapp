                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    <p style="margin-bottom: 10px;"><strong>Hello {{ $details['fullname_f1'] }}</strong>,</p>
                                    <p style="margin-bottom: 10px;">Selamat !!! Proses Registrasi Member Mitra/Kurir anda sudah selesai. berikut adalah Username dan Password untuk login ke dalam Aplikasi Kami :</p>
                                    <p style="margin-bottom: 10px;">Url Aplikasi : dev.joinkilat.com</p>
                                    <p style="margin-bottom: 15px;">Username : {{ $details['username_f'] }} </p>
                                    <p style="margin-bottom: 15px;">Password : 123456 </p><br>
                                    <p style="margin-bottom: 15px;">Silahkan Lakukan Pergantian Password saat anda Pertama Kali Login Ke dalam Aplikasi. Agar tidak terjadi hal-hal yang tidak diinginkan. </p>
                                    <p style="margin-top: 35px; margin-bottom: 15px;">---- <br> Regards<br>Join Kilat Admin</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
