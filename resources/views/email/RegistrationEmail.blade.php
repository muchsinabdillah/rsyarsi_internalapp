                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    <h5 style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">Hi {{ $details['fullname'] }}<br>Your Application was sent successfully !</h5>
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">We are still working on your identity verification. Once our team verified your indentity, you will be whitelisted and notified by email.</p>
                                    <p style="margin-bottom: 15px;">Hope you'll enjoy the experience, we're here if you have any questions, drop us a line at customerservice@joinkilat.com anytime. </p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2022 Joinkilat.com. All rights reserved.</p>
