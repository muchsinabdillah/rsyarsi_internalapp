                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="#"><img style="height: 40px" src="{{ $image }}" alt="logo"></a>
                                    <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Join Kilat</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Konfirmasi Pendaftaran</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Hi {{ $details['fullname'] }},</p>
                                    <p style="margin-bottom: 10px;">Untuk melanjutkan ke Tahap selanjutnya, ada beberapa langkah lagi yang harus kamu lakukan. yaitu :</p>
                                    <p style="margin-bottom: 25px;">1. Silahkan kamu verifikasi data kembali dan Upload Identitas KTP Kamu pada link <a href="{{ env('APP_URL') }}/verificationregistration/{{ $details['id'] }}" target="_blank" >Confirm Data.</a></p>
                                    <p style="margin-bottom: 10px;">2. Silahkan Kamu Isikan Form yang Kami Attch kan di email ini, lalu setelah diisi kirimkan kembali ke customerservice@joinkilat.com dengan Subject : CONFIRMATION REGISTRATION -spasi- NAMA_KAMI. </p>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2022 Join Kilat. All rights reserved.</p>
