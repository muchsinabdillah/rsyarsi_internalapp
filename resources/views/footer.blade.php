<footer class="footer bg-lighter" id="footer">
                <div class="container">
                        ...
                        <div class="col-md-3">
                            <div class="footer-logo">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img" src="{{ URL::asset('images/logo.png') }}" srcset="{{ URL::asset('images/logo2x.png') }}" alt="logo">
                                    <!-- <img class="logo-dark logo-img" src="{{ URL::asset('images/logo-dark.png') }}" srcset="{{ URL::asset('images/logo-dark2x.png') }}" alt="logo-dark"> -->
                                </a>
                            </div><!-- .footer-logo -->
                        </div><!-- .col -->
                    ...
                    <div class="row g-3 align-items-center justify-content-md-between py-4">
                        <div class="col-md-8">
                            <div class="text-base">Copyright &copy; 2022 JoinKilat.</div>
                        </div><!-- .col -->
