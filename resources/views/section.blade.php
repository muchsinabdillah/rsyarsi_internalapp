<section class="section section-feature"  id="home">
                <div class="container">
                    <div class="row align-items-center justify-content-between g-gs">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 left">
                                <img src="{{ URL::asset('images/gfx/3.joinkilat.png') }}" alt="img">
                            </div>
                        </div><!-- .col -->
                        <div class="col-lg-6">
                            <div class="text-block">
                                <h2 class="title">Selamat Datang</h2>
                                <p class="lead">Join Kilat memiliki berbagai solusi sesuai kebutuhan logistik perusahaan Anda</p>
                                <ul class="btns-inline">
                                    <li><a href="/login" class="btn btn-lg btn-primary" style="background-color: red"><span>Login App</span></a></li>
                                </ul>
                            </div><!-- .text-block -->
                        </div><!-- .col -->
                    </div><!-- .row -->
            ...
            <section class="section section-feature pb-0" id="aboutus">
                <div class="container">
                    <div class="row align-items-center justify-content-lg-between g-gs">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 left">
                                <img src="{{ URL::asset('images/gfx/1.joinkilat.jpeg') }}" alt="img">
                            </div><!-- .img-block -->
                        </div><!-- .col -->
                        <div class="col-lg-6">
                            <div class="text-block me-xl-5">
                                <h2 class="title"><span class="text-primary">TENTANG</span> <span class="text-pink">KAMI</span></h2>
                                <div class="review review-s3">
                                    <div class="review-content">
                                        ...
                                        <div class="review-text">
                                            <p>JOINKILAT bergerak di bidang Logistik dan Jasa Pengiriman. dimana sector ini mengalami lonjakan pertumbuhan saat Pedemi Covid 19. Seiring dengan perkembangan dunia usaha Daring dan E-Commerce yang kian berkembang pesat. Maraknya jual beli Online, Pesan Antar, serta kebutuhan akan barang menjadikan JOINKILAT hadir dengan layanan jasa pengiriman CEPAT dan TEPAT.</p>
            ...
            <section class="section section-service pb-0"  >
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-sm-7 col-md-6 col-9">
                            <div class="section-head">
                                <h2 class="title">Kenapa harus mengunakan Jasa Join Kilat</h2>
                            </div><!-- .section-head -->
                        </div><!-- .col -->
                    </div><!-- .row -->
		...
		C412.9,398.1,398.1,412.9,379.9,412.9z" />
            ...
            <section class="section section-pricing bg-lighter" id="produk">
                <div class="container">
                    ...
                    <div class="row justify-content-center justify-content-lg-between align-items-center text-center g-gs">
                        <div class="col-xl-4 col-sm-6">
                            <div class="pricing pricing-s1 card card-shadow round-xl">
                                <div class="card-inner card-inner-lg">
                                    <img src="{{ URL::asset('images/gfx/JOKI.jpg') }}" alt="img">
                                    <!-- <h2 class="pricing-amount"> Rp.7.500 </h2>
                                    <span class="sub-title">JOKI</span> -->
                                    <h5 class="pricing-title">Paket JOKI</h5>
                                    <ul class="pricing-features list list-nostyle">
                                        <li>Kiriman Mulai dari 5000,-</li>
                                        <li>se-JABODETABEK 2-3 hari</li>
                                        <!-- <li><del>Additional Features</del></li>
                                        <li><del>6GB Storage</del></li> -->
                                    </ul>
                                    <div class="pricing-action">
                                        {{-- <a href="#" class="btn btn-primary btn-lg btn-block" style="background-color: red" ><span>KLIK</span></a> --}}
                                    </div>
                                </div>
                            </div>
                        </div><!-- .col -->
                        <div class="col-xl-4 col-sm-6">
                            <div class="pricing  pricing-s1 card card-shadow round-xl">
                                <div class="card-inner card-inner-lg">
                                    <img src="{{ URL::asset('images/gfx/JOKIREG.jpg') }}" alt="img">
                                    <!-- <h2 class="pricing-amount"> Rp.8.500 </h2>
                                    <span class="sub-title">JOKIREG</span> -->
                                    <h5 class="pricing-title">Paket JOKIREG</h5>
                                    <ul class="pricing-features list list-nostyle">
                                        <li>Kiriman Per-Kilo  8500,-</li>
                                        <li>se-JABODETABEK 1-2 hari </li>
                                        <!-- <li><del>Additional Features</del></li>
                                        <li><del>6GB Storage</del></li> -->
                                    </ul>
                                    <div class="pricing-action">
                                        {{-- <a href="#" class="btn btn-primary btn-lg btn-block" style="background-color: red" style="color: white"><span>KLIK</span></a> --}}
                                    </div>
                                </div>
                            </div>
                        </div><!-- .col -->
                        <div class="col-xl-4 col-sm-6">
                            <div class="pricing pricing-s1 card card-shadow round-xl">
                                <div class="card-inner card-inner-lg">
                                    <img src="{{ URL::asset('images/gfx/JOKIL.jpg') }}" alt="img">
                                    <!-- <h2 class="pricing-amount"> Rp.17.000 </h2>
                                    <span class="sub-title">JOKIL</span> -->
                                    <h5 class="pricing-title">Paket JOKIL</h5>
                                    <ul class="pricing-features list list-nostyle">
                                        <li>Kiriman Per-Kilo  17000,-</li>
                                        <li>se-JABODETABEK 1 hari </li>
            ...
            <section class="section section-testimonial pb-0" id="mitra">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-7 col-md-8 col-10">
                            <div class="section-head">
                                <h2 class="title">KEMITRAAN</h2>
                            </div>
                        </div><!-- .col -->
                    </div><!-- .row -->
                            ...
                            <div class="accordion accordion-s1 card card-shadow border-0 round-xl" id="accordion">
                                <div class="accordion-item">
                                    <a href="#" class="accordion-head" data-bs-toggle="collapse" data-bs-target="#accordion-item-1">
                                        <h6 class="title">Mengapa saya harus Bergabung dengan JoinKilat?</h6>
                                        <span class="accordion-icon"></span>
                                    </a>
                                    <div class="accordion-body collapse show" id="accordion-item-1" data-bs-parent="#accordion">
                                        <div class="accordion-inner">
                                            <p>1. Tererintegrasi dengan Kapal pelni, pesawat kargo, KRL dan kurir kami ada di berbagai daerah di Indonesia.</p>
                                            <p>2. Tidak dibebankan biaya (GRATIS) untuk jadi mitra.</p>
                                            <p>3. Diberikan Spanduk, Brosur dan Stiker dari pusat.</p>
                                        </div>
                                    </div>
                                </div><!-- .accordion-item -->
                                <div class="accordion-item">
                                    <a href="#" class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-item-2">
                                        <h6 class="title">Bagaimana cara saya mendaftar menjadi Mitra/Kurir di JoinKilat?</h6>
                                        <span class="accordion-icon"></span>
                                    </a>
                                    <div class="accordion-body collapse" id="accordion-item-2" data-bs-parent="#accordion">
                                       <div class="accordion-inner">
                                            <p>1. Silahkan anda mengisi formulir Pendaftaran pada link <a href="/register" target="_blank" >disini</a>.</p>
                                            <p>2. Admin Kami akan merespon dengan mengirimkan E-mail Konfirmasi.</p>
                                            <p>3. Anda akan diminta untuk melakukan upload Foto KTP dan Upload Form IKS.</p>
                                            <p>4. Tahap terakhir adalah anda akan dikirimkan E-mail yang berisi username dan password.</p>
                                        </div>
                                    </div>
                                </div><!-- .accordion-item -->
                                <div class="accordion-item">
                                    <a href="#" class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-item-3">
                                        <h6 class="title">Bagaimana saya login ke Dalam Dashboard Aplikasi?</h6>
                                        <span class="accordion-icon"></span>
                                    </a>
                                    <div class="accordion-body collapse" id="accordion-item-3" data-bs-parent="#accordion">
                                        <div class="accordion-inner">
                                            <p>Silahkan anda melakukan Login Aplikasi pada link <a href="/login" target="_blank" >disini</a>.</p>
                                        </div>
                                    </div>
                                </div><!-- .accordion-item -->
            ...
            <section class="section section-cta" id="mitra">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="text-block is-compact">
                                <div class="img-block h-150px mb-4"> 
                                    <img src="{{ URL::asset('images/gfx/arrow-down-animated.gif') }}" alt="" style="width: 200px"> 
                                </div>
                                <h2 class="title">DAFTAR JADI MITRA</h2>
                                 <p class="lead">Ingin Menjadi Mitra/Kurir di Perusahaan Kami ? Tunggu apalagi, silahkan Join dengan Kami.</p>
                                
                                 <ul class="btns-inline justify-center">
                                    <li>
                                        <a href="/register" style="background-color: red" class="btn btn-xl btn-primary">JOIN </a>
                                     </li>
                                </ul>
                            </div>
                        </div><!-- ,col -->
